...
class RuntimeConfig:
    ...
    EXPORT_JOB_TTL_HOURS: int = field(default_factory=lambda: _env_int("EXPORT_JOB_TTL_HOURS", 24))
...
class SecurityConfig:
    ...
    EDGE_HTTPS_ENABLED: bool = field(default_factory=lambda: _env_bool("EDGE_HTTPS_ENABLED", True))
    HSTS_ENABLED: bool = field(default_factory=lambda: _env_bool("HSTS_ENABLED", True))
    SESSION_COOKIE_SECURE_ENABLED: bool = field(default_factory=lambda: _env_bool("SESSION_COOKIE_SECURE_ENABLED", True))
    APP_HOST_BIND: str = field(default_factory=lambda: _env_str("APP_HOST_BIND", "127.0.0.1"))
    APP_HOST_PORT: int = field(default_factory=lambda: _env_int("APP_HOST_PORT", 7005))
    HTTPS_PORT: int = field(default_factory=lambda: _env_int("HTTPS_PORT", 7003))
    CANONICAL_HTTPS_HOST: str = field(default_factory=lambda: _env_str("CANONICAL_HTTPS_HOST", ""))
    ADMIN_LOGIN_RATE_LIMIT: str = field(default_factory=lambda: _env_str("ADMIN_LOGIN_RATE_LIMIT", "10 per 15 minute"))
